...
output_root = Path("data/processed") / video_id / "frames"
...
while start_time < duration:
    ...
    for i in range(frames_per_segment):
        ...
        ratio = (i + 1) / (frames_per_segment + 1)

        sample_time = start_time + segment_duration * ratio
    ...
    for frame_number, sample_time in enumerate(sample_times, start=1):
